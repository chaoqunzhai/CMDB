# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-06-12 15:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kernel', models.CharField(blank=True, max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='salt.Hostname')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salt_leader', models.ManyToManyField(to='salt.Saltrun')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='hostname',
            name='role_type',
            field=models.ManyToManyField(blank=True, default=1, null=True, to='salt.Userprofile'),
        ),
        migrations.AddField(
            model_name='hostname',
            name='species_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='salt.Species', verbose_name='业务线经理'),
        ),
